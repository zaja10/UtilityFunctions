...
# A complete trial
plot_trial_map(data,
  trial_val = "Loc1_2018", trial_col = "Trial",
...
# A trial with gaps
plot_trial_map(data,
  trial_val = "Loc1_2019", trial_col = "Trial",
  row = "Row", col = "Column", val = "Yield"
)
```
...
data_padded <- pad_trial_layout(data, row = "Row", col = "Column", group_cols = "Trial")
