---
title: "Stage 2: Factor Analytic Models (MET)"
...
# library(tidyverse) # Removed to demonstrate standalone capability
...
Use `fit_fa_model` to extract parameters, perform rotation, and calculate selection indices.

```{r, eval = FALSE}
# Extract & Rotate (Varimax)
# 'classify' must match the FA term in the model
model_fa <- fit_fa_model(model_fit, classify = "fa(env, 2):gen")
```
