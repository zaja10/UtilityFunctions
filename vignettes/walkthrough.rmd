...
## 1. Site Repeatability

We calculate the repeatability ($R = \sigma^2_g / (\sigma^2_g + \sigma^2_e)$) for each site. This metric is crucial for clonal crops or when identifying sites with high error noise.

```{r}
# Calculates R per site, automatically extracting residual variances
